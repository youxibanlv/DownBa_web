...
<script type="text/javascript">
	...
	function changeBg(){
		...
		$("#appTable tr").on('click',function(){
			appid = $(this).find("td").eq(0).text();//设置appid
...
<div id="dcMain">
	...
	<div class="mainBox imgModule">
		...
		<div style="width: 100%; height: 100%">
			<fieldset style="width: 40%; height: 100%">
				<legend>
					<font color="red">添加轮播图</font>
				</legend>
				app名称：<input type="text" name="show_name" value="" size="20"
				...
				广告图片:<input type="file" name="show_img" class="inpFlie" accept="image/*"  placeholder="建议使用png格式"/><br><br>
				链接地址:<input type="text" name="show_link" value="" size="40" class="inpMain" placeholder="若不输入，默认app详情界面" /><br><br>
				排序：<input type="text" name="sort" value="5" size="20" class="inpMain" maxlength="1" pattern="[0-9]"/><br><br>
				<center><input name="submit" class="btn" type="button" value="提交" width="100%"></center>
			</fieldset>
		</div>
		<!-- 右侧轮播图列表 -->
